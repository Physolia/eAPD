...
// const activitySchema = require('../schemas/activity.json');
...
const patch = () => {
  ...
  const operation = { op: 'replace', path: '/firstName', value: 'Joachim' };
  return applyOperation(document, operation);
};

// const update = async () => {
//   console.log('MONGO_URL', process.env.MONGO_URL);
//   const patches = [{ op: 'replace', path: '/hello', value: 'world' }];
//   const mongoUpdate = toMongodb(patches);
...
//       .eapd()
//       .test()
//       .update({ _id: { $oid: '6089ce2d2f3a7dae05d08042' } }, mongoUpdate, {
//         upsert: true
//       });
//     console.log({ results });
//   } catch (e) {
...
const convertToMongoose = async () => {
  // console.log(util.inspect(apdSchema, false, null));
  // console.log(util.inspect(activitySchema, false, null));
  ...
  //         },
  //         { endDate: '2017-12-31', milestone: 'Environmental Scan Completion' },
  //         { endDate: '2018-05-30', milestone: 'HIT Roadmap Development' }
  //       ],
  ...
  //       ],
  //       summary:
  //         '<p>Continued Operations of the Medicaid EHR Incentive Payment Program, includes modifications to the SLR, HIT staff, auditing, outreach, and non-personnel expenses for administering the program.</p>',
  //       quarterlyFFP: {
  //         2020: {
  ...
  //       costAllocation: {
  //         2020: { ffp: { federal: 90, state: 10 }, other: 0 },
  //         2021: { ffp: { federal: 75, state: 25 }, other: 0 }
  //       },
  //       costAllocationNarrative: {
  //         2020: {
  //           otherSources:
  ...
  //       plannedStartDate: '',
  //       schedule: [
  //         { endDate: '2018-12-31', milestone: 'Implement MMIS-HIE Interface' },
  //         {
  //           endDate: '2018-12-31',
  ...
  //       ],
  //       summary:
  //         '<p>To provide healthcare statistical information and support MU, Tycho plans to interface the MMIS Data Warehouse (DW) to the HIE so that Medicaid claims data can be made available to consumers in their Personal Health Record (PHR) within the HIE.</p>',
  //       quarterlyFFP: {
  //         2020: {
  //           1: { combined: 25, contractors: 25, inHouse: 25 },
  //           2: { combined: 25, contractors: 25, inHouse: 25 },
  ...
  //         },
  //         { endDate: '2020-12-31', milestone: 'Development of Roadmap' },
  //         { endDate: '2020-01-01', milestone: 'HIE Staff Augmentation' },
  //         { endDate: '2020-01-01', milestone: 'Modules for Care Coordination' },
  //         { endDate: '2021-09-30', milestone: 'Provider Onboarding' },
  //         { endDate: '2020-01-01', milestone: 'EDIE System Implementation' },
  //         {
  //           endDate: '2020-12-31',
  ...
  //         },
  //         { endDate: '2020-09-30', milestone: 'Onboard Lab Providers' },
  //         {
  //           endDate: '2018-12-31',
  //           milestone:
  ...
  //       plannedStartDate: '',
  //       schedule: [
  //         { endDate: '2020-04-01', milestone: 'PHR/Blue Button HIE Build' },
  //         { endDate: '2018-12-31', milestone: 'Blue Button Implementation' },
  //         {
  //           endDate: '2018-12-31',
  ...
  //       ],
  //       costAllocation: {
  //         2020: { ffp: { federal: 50, state: 50 }, other: 0 },
  //         2021: { ffp: { federal: 90, state: 10 }, other: 0 }
  //       },
  //       costAllocationNarrative: {
  //         2020: { otherSources: '' },
  ...
  //       plannedStartDate: '',
  //       schedule: [
  //         { endDate: '2020-02-28', milestone: 'MITA 3.0 SS-A Project' },
  //         { endDate: '2020-12-31', milestone: 'HITECH SS-A Assessment' }
  //       ],
  //       standardsAndConditions: { doesNotSupport: '', supports: '' },
  //       statePersonnel: [
  //         {
  ...
  try {
    // await akApd.save();
    const mongoUpdate = toMongodb([
      {
        op: 'add',
        path: '/activities/0/outcomes/1/metrics/-',
        value: { key: '37bbf589', metric: '' }
      },
      {
        op: 'replace',
        path: '/activities/0/outcomes/1/metrics/3/metric',
        value: 'Testing metric'
      }
    ]);
    mongoUpdate.forEach(async update => {
      console.log(JSON.stringify(update));
      await APD.updateOne({ _id: '609038772cbf359ce48a6e16' }, update);
    });
  } catch (e) {
    console.error(e);
  } finally {
